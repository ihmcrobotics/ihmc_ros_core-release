...
## ihmc_ros_core (indigo) - 0.9.1-3

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo ihmc_ros_core` on `Fri, 24 Feb 2017 18:47:34 -0000`
...
## ihmc_ros_core (indigo) - 0.9.1-2

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo ihmc_ros_core` on `Fri, 24 Feb 2017 13:24:46 -0000`
...
## ihmc_ros_core (indigo) - 0.9.1-1

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo ihmc_ros_core` on `Thu, 23 Feb 2017 20:02:14 -0000`
...
## ihmc_ros_core (indigo) - 0.9.1-0

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo ihmc_ros_core` on `Thu, 23 Feb 2017 18:46:57 -0000`
...
## ihmc_ros_core (indigo) - 0.8.0-6

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo ihmc_ros_core` on `Sat, 22 Oct 2016 00:00:18 -0000`
...
## ihmc_ros_core (indigo) - 0.8.0-5

The packages in the `ihmc_ros_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo ihmc_ros_core` on `Fri, 21 Oct 2016 01:32:10 -0000`
